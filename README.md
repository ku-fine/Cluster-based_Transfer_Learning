This repository contains the MATLAB source code for the paper **"Applications of cluster-based transfer learning in image and localization tasks"**. The datasets used in our experiments are also included.  
